...
class Character extends FNFSprite
{
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf':
				frames = Paths.getSparrowAtlas('characters/sprites/bf');
				...
				animation.addByPrefix('singUP-alt', 'altbf altup0', 24, false);
				animation.addByPrefix('singLEFT-alt', 'altbf altleft0', 24, false);
				animation.addByPrefix('singRIGHT-alt', 'altbf altright0', 24, false);
				animation.addByPrefix('singDOWN-alt', 'altbf altdown0', 24, false);
				animation.addByPrefix('hey', 'altbf hey', 24, false);
			...
			case 'ori':
				...
				tex = Paths.getSparrowAtlas('characters/sprites/ori_assets');
				frames = tex;
				animation.addByPrefix('idle', 'ori idle0', 24, false);
				animation.addByPrefix('singUP', 'ori up0', 24, false);
				if (!isPlayer) {
				animation.addByPrefix('singLEFT', 'ori left0', 24, false);
				animation.addByPrefix('singRIGHT', 'ori right0', 24, false);
				animation.addByPrefix('singLEFTalt', 'ori left0', 24, false);
				animation.addByPrefix('singRIGHTalt', 'ori right0', 24, false);
				} else {
				animation.addByPrefix('singLEFT', 'ori right0', 24, false);
				animation.addByPrefix('singRIGHT', 'ori left0', 24, false);
				animation.addByPrefix('singLEFTalt', 'ori right0', 24, false);
				animation.addByPrefix('singRIGHTalt', 'ori left0', 24, false);
				}
				animation.addByPrefix('singDOWN', 'ori down0', 24, false);
				...
				playAnim('idle');
				barColor = 0xFFFFFFFF;
			case 'discord': // don't ask
				tex = Paths.getSparrowAtlas('characters/sprites/discord');
				frames = tex;
				animation.addByPrefix('idle', 'discord', 24, false);
			...
			case 'evilori':
				...
				animation.addByPrefix('aim', 'aim0', 24);
				animation.addByPrefix('shoot', 'shoot0', 24);
